const installHandler = () => {
  ...
  /* adjusting the layout with the screen ratio */
  function checkRatio() {
  ...
  window.addEventListener('message', event => {
    if (event.origin.includes('livescale.tv')) {
...
//Need this just for testing
if (window.self === window.top) {
  document.addEventListener('DOMContentLoaded', installHandler);
  document.addEventListener('InitLivescale', installHandler);
}
