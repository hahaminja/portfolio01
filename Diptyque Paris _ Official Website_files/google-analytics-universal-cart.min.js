...
productsOut.push({'item_id':itemId,'item_name':productsIn[i].name,'price':productsIn[i].price,'quantity':parseInt(productsIn[i].qty,10),'item_brand':"Diptyque Paris",'item_category':"",'item_category2':"",'item_category3':"",'item_variant':"",'item_list_name':"",'index':i,});}}
return productsOut;},cartItemAdded:function(){if(!this.addedProducts.length){return;}
this.dataLayer.push({'event':'add_to_cart','ecommerce':{'currencyCode':this.dlCurrencyCode,'add':{'products':this.formatProductsArray(this.addedProducts)}}});this.addedProducts=[];},cartItemRemoved:function(){if(!this.removedProducts.length){return;}
this.dataLayer.push({'event':'remove_from_cart','ecommerce':{'items':this.formatProductsArray(this.removedProducts)}});this.removedProducts=[];},parseAddToCartCookies:function(){var addProductsList;if(getCookie(this.cookieAddToCart)){this.addedProducts=[];addProductsList=decodeURIComponent(getCookie(this.cookieAddToCart));this.addedProducts=JSON.parse(addProductsList);delCookie(this.cookieAddToCart);this.cartItemAdded();}},parseRemoveFromCartCookies:function(){var removeProductsList;if(getCookie(this.cookieRemoveFromCart)){this.removedProducts=[];removeProductsList=decodeURIComponent(getCookie(this.cookieRemoveFromCart));this.removedProducts=JSON.parse(removeProductsList);delCookie(this.cookieRemoveFromCart);this.cartItemRemoved();}}};return GoogleAnalyticsUniversalCart;});